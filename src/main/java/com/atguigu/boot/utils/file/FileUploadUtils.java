...
//
//import static com.atguigu.boot.exception.code.ExceptionCode.*;
//
///**
// * 文件上传工具类
// *
...
//     * 默认上传的地址
//     */
//    private static String defaultBaseDir = FileConfig.getFileBasePath();
//
...
////            throw new BizException(REQUIRED_FILE_NAME_TOO_LONG);
////        }
////
...
//            throw new BizException(REQUIRED_FILE_SIZE_TOO_BIG);
//        }
//        String extension = getExtension(file);
//        if (allowedExtension != null && !isAllowedExtension(extension, allowedExtension)) {
//            throw new BizException(REQUIRED_FILE_EXTENSION_DENY);
//        }
//    }
//
//    /**
