...
//        Pet tom11 = run.getBean("tom22", Pet.class);
//        System.out.println(tom11==tom22);
//        System.out.println(tom11.equals(tom22));
//        MyConfig beanConfig = run.getBean(MyConfig.class);
//        System.out.println(beanConfig);
//
//        User user01 = beanConfig.user01();
//        User user02 = beanConfig.user01();
//        System.out.println(user01==user02);
//        System.out.println(user01.equals(user02));
//        boolean haha = run.containsBean("haha");
//        boolean hehe = run.containsBean("hh");
